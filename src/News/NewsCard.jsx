...
const NewsCard = ({image, date, blogger, numberOfComments, title, previewText}) => {
    return(
        <a href="/" className="newscard__link">
            <div className="newsCard">
            <div className="newscard__header">
                <div className="newscard__image">
                    <img src={image} alt="news _image preview" className="newscard__image--img" />
                </div>
                <div className="newscard__details">
                    ...
                    <span className="newscard__details--box">
                        <Comment /> <p className="newscard__details--text">{numberOfComments} comments</p>
                    </span>
                </div>
            </div>
